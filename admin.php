      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <nav class="logo">
              <h4> <img src="assets/images/wmsu.png" alt=""> ADMIN DASHBOARD </h4>
            </nav>
            <a href="index.php">

              <button type="button" class="btn btn-outline-light" style="margin-top: 35px; float: right">LOGOUT</button>
            </a>
