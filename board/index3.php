            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">jubilarian</a>
                        <a class="collapse-item" href="utilities-border.html">ruby jubilarian</a>
                        <a class="collapse-item" href="utilities-animation.html">sapphire jubiambut</a>
                        <a class="collapse-item" href="utilities-other.html">basta award</a>
                    </div>
                </div>
            </li>
...
<?php
  ...
  $shs_count = "SELECT seniorhighschool_id FROM seniorhighschool";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Website namin nina yza wag niyo kopyahin yawa kayo   </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
